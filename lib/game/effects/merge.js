...
.defines(function() {
    ...
    init: function(x, y, settings) {
      ...
      for( var i = 0; i < this.particles; i++ ) {
        if(ig.game.spawnEntity) {
          ig.game.spawnEntity(EffectMergeParticle, x, y, { colorOffset: settings.colorOffset ? settings.colorOffset : 0 });
  ...
  EffectMergeParticle = ig.Entity.extend({
    size: {x: 4, y: 4},
    lifetime: 3,
