...
MyGame = ig.Game.extend({
  ...
  loadLevel: function( level ) {
    ...
    var mappings = [[ gamepad.start, ig.KEY.ESC ],
                    [ gamepad.dpadDown, ig.KEY.Z ],
                    [ gamepad.dpadLeft, ig.KEY.LEFT_ARROW ],
                    [ gamepad.dpadRight, ig.KEY.RIGHT_ARROW ],
                    [ gamepad.faceButton0, ig.KEY.TAB ],
                    [ gamepad.faceButton1, ig.KEY.X ],
                    [ gamepad.faceButton2, ig.KEY.C ]];
...
StartScreen = ig.Game.extend({
  ...
  update: function() {
    ...
    var mappings = [[ gamepad.start, ig.KEY.SPACE ]];
