...
MyGame = ig.Game.extend({
  ...
  bindInput: function(mode) {
    ...
    if (mode === 'cutscene') {
      ...
      this.buttons = [
        new ig.TouchButton( 'exit', ig.system.width / 2 - buttonSize / 2, 0, 80, buttonSize, this.buttonImage, 2 )
      ];
    } else {
      // Sneaky stuff
      ...
      this.buttons = [
        new ig.TouchButton( 'pause', ig.system.width / 2 - buttonSize / 2, 0, 80, buttonSize, this.buttonImage, 2 ),
