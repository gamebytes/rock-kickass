...
MyGame = ig.Game.extend({
  ...
  bindInput: function() {
    ...
    if( ig.ua.mobile ) {
      ...
      this.buttons = [
        new ig.TouchButton( 'esc', ig.system.width / 2 - buttonSize / 2, 0, buttonSize, buttonSize, this.buttonImage, 0 ),
        new ig.TouchButton( 'left', 0, ig.system.height - buttonSize, buttonSize, buttonSize, this.buttonImage, 1 ),
        new ig.TouchButton( 'right', buttonSize, ig.system.height - buttonSize, buttonSize, buttonSize, this.buttonImage, 2 ),
        new ig.TouchButton( 'jump', ig.system.width - buttonSize * 2, ig.system.height - buttonSize, buttonSize, buttonSize, this.buttonImage, 3 ),
        new ig.TouchButton( 'shoot', ig.system.width - buttonSize, ig.system.height - buttonSize, buttonSize, buttonSize, this.buttonImage, 4 ),
        new ig.TouchButton( 'switch', ig.system.width - buttonSize, 0, buttonSize, buttonSize, this.buttonImage, 5 )
      ];
    }
  },
...
StartScreen = ig.Game.extend({
  ...
  init: function() {
      ...
      if( ig.ua.mobile ) {
        ...
        this.buttons = [
          new ig.TouchButton( 'start', 0, 0, ig.system.width, ig.system.height, this.buttonImage, 0 )
        ];
      }
...
if( ig.ua.iPhone4 ) {
  ...
  ig.main( '#canvas', MusicLoader, 60, width, height, 1, ig.ImpactSplashLoader );
} else {
