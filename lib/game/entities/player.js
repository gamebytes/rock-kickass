...
.defines(function() {
  EntityPlayer = ig.Entity.extend({
    ...
    receiveDamage: function( amount, from ) {
      ...
      ig.game.spawnEntity( EntityPlayerDebris, this.pos.x, this.pos.y);
    ...
    kill: function() {
      ...
      ig.game.spawnEntity( EntityPlayerDebris, this.pos.x, this.pos.y, { count: 30 });
    ...
    setupAnimation: function() {
      ...
      this.addAnim( 'run', 0.1, [12 + offset,13 + offset,14 + offset,15 + offset,16 + offset,17 + offset,18 + offset,19 + offset,20 + offset] );
