...
.defines(function() {
  EntityHealthBar = ig.Entity.extend({
    ...
    // tie this in to the HUD enabled state. healthbars are a function of RK's HUD
    // this has nothing to do with me being a lazy shit, seriously ;)
    draw: function() {
      if( ig.game.hud.enabled )
        this.parent();
    }
  });
});
