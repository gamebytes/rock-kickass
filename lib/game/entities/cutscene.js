      ...
      if(this.active) {
        ...
        if(this.currentTextIndex < this.text.length) {
          ...
          if (line.entity === 'center') {
            ...
            ig.game.font.draw( line.text, x, y, ig.fontRenderSwitcher.align.center, '#000000');
          } else {
            ...
            if( x - halfTextWidth < 10 ) {
              x = 10;
              font.draw( line.text, x, y, ig.fontRenderSwitcher.align.left, '#000000' );
            } else {
              font.draw( line.text, x, y, ig.fontRenderSwitcher.align.center, '#000000' );
            }
