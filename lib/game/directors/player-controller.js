...
.defines(function(){
  ig.PlayerController = ig.Class.extend({
    ...
    init: function() {
      ...
      this.allWeapons.push(new WeaponPea(0, 0, {}).getForInventory());
      this.allWeapons.push(new WeaponPistol(0, 0, {}).getForInventory());
      this.allWeapons.push(new WeaponGrenade(0, 0, {}).getForInventory());
      this.allWeapons.push(new WeaponShotgun(0, 0, {}).getForInventory());
      this.allWeapons.push(new WeaponRocketLauncher(0, 0, {}).getForInventory());
      this.allWeapons.push(new WeaponBfg(0, 0, {}).getForInventory());
    },
